...
if($jsondata->token!=""&&$jsondata->sessionid!=""&&$openid!=""){
	exitJson(0, '已登录',array('token'=>$jsondata->token,'sessionid'=>$jsondata->sessionid)+getUserInfo($openid));
}
